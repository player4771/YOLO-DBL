...
class Spatial_Attention(nn.Module):
    ...
    """
    def __init__(self, dim, idx, split_size:tuple[int,int]=(8,8), dim_out=None, num_heads=6, attn_drop=0., proj_drop=0., qk_scale=None, position_bias=True):
        super().__init__()
        self.dim = dim
...
class Adaptive_Spatial_Attention(nn.Module):
    ...
    def __init__(self, dim, num_heads,
                 reso=64, split_size:tuple[int,int]=(8,8), shift_size:tuple[int,int]=(1,2), qkv_bias=False, qk_scale=None,
...
class DATB(nn.Module):
    def __init__(self, dim, num_heads, reso=64, split_size:tuple[int,int]=(2,4), shift_size:tuple[int,int]=(1,2),
