...
#############################################################
        params = {
            'tiny': {
                64:  {'n_groups':1, 'top_k_def':16, 'kk':9, 'stride_def':8, 'expain_ratio':3, 'q_size':to_2tuple(56)},
                128: {'n_groups':2, 'top_k_def':16, 'kk':7, 'stride_def':4, 'expain_ratio':3, 'q_size':to_2tuple(28)},
                256: {'n_groups':4, 'top_k_def':4,  'kk':5, 'stride_def':2, 'expain_ratio':3, 'q_size':to_2tuple(14)},
                512: {'n_groups':8, 'top_k_def':49, 'kk':3, 'stride_def':1, 'expain_ratio':3, 'q_size':to_2tuple(7)},
            },
            'small': {
                64:  {'n_groups':1, 'top_k_def':16, 'kk':9, 'stride_def':8, 'expain_ratio':3, 'q_size':to_2tuple(56)},
                128: {'n_groups':2, 'top_k_def':16, 'kk':7, 'stride_def':4, 'expain_ratio':3, 'q_size':to_2tuple(28)},
                256: {'n_groups':4, 'top_k_def':4,  'kk':5, 'stride_def':2, 'expain_ratio':3, 'q_size':to_2tuple(14)},
                512: {'n_groups':8, 'top_k_def':49, 'kk':3, 'stride_def':1, 'expain_ratio':1, 'q_size':to_2tuple(7)},
            },
            'base': {
                96:  {'n_groups':1, 'top_k_def':16, 'kk':9, 'stride_def':8, 'expain_ratio':3, 'q_size':to_2tuple(56)},
                192: {'n_groups':2, 'top_k_def':16, 'kk':7, 'stride_def':4, 'expain_ratio':3, 'q_size':to_2tuple(28)},
                384: {'n_groups':3, 'top_k_def':4,  'kk':5, 'stride_def':2, 'expain_ratio':3, 'q_size':to_2tuple(14)},
                768: {'n_groups':6, 'top_k_def':49, 'kk':3, 'stride_def':1, 'expain_ratio':3, 'q_size':to_2tuple(7)},
            }
        }
        for k,v in params[param_size][dim].items():
            setattr(self, k, v)
...
##########################################################################################
        ...
        self.conv_offset_q = nn.Sequential(
                        nn.Conv2d(
                            ...
                            (self.stride_def, self.stride_def), (self.kk//2, self.kk//2),
...
class Block(nn.Module):
    ...
    def __init__(self, dim, drop_path=0., layer_scale_init_value=-1,
        ...
        topk1 = {4:1, 8:4, 16:16, -2:49, -1:None}[topk]
        topk2 = {4:topk, 8:topk, 16:topk, -2:49, -1:None}[topk]

        if topk > 0:
            self.attn1 = BiLevelRoutingAttention(**args, topk=topk1)
            self.attn2 = DeBiLevelRoutingAttention(**args, topk=topk2, param_size=param_size)
        elif topk == -1:
