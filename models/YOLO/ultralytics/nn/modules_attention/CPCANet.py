...
class ChannelAttention(nn.Module):
    ...
    def __init__(self, input_channels:int, internal_neurons):
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size:int|tuple=4, in_chans=4, embed_dim=96, norm_layer=None):
        super().__init__()
