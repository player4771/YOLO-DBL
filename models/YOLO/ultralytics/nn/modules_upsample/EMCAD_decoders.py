#https://github.com/SLDGroup/EMCAD/blob/main/lib/decoders.py
...
class MSDC(nn.Module):
    def __init__(self, in_channels:int, kernel_sizes, stride, activation='relu6', dw_parallel=True):
...
class MSCB(nn.Module):
    ...
    def __init__(self, in_channels:int, out_channels:int, stride, kernel_sizes=[1, 3, 5],
                 expansion_factor=2, dw_parallel=True, add=True, activation='relu6'):
...
class EUCB(nn.Module):
    def __init__(self, in_channels:int, out_channels:int=None, kernel_size=3, stride=1, activation='relu'):
...
class CAB(nn.Module):
    def __init__(self, in_channels:int, out_channels:int=None, ratio=16, activation='relu'):
